...
// A mall manager (or admin/super_admin) already holds approval authority,
// so their edit publishes immediately; a mall staff edit goes back to
// pending for re-approval — same reasoning as stores/update.php.
$fields[] = 'status = ?';
$params[] = ($user['role'] === 'mall_manager' || is_admin($user)) ? 'approved' : 'pending';
