<?php
// Google Maps JavaScript API key, for the store-location picker on
// my-store.html (see endpoints/maps/config.php, js/my-store.js).
//
...
//
// Leaving this empty disables the location picker entirely — my-store.js
